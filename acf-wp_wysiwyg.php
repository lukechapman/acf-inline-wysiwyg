...
function inline_wysiwyg_enqueue_scripts() {
	...
	wp_enqueue_script( 'inline-wysiwyg-js', plugin_dir_url( __FILE__ ) . '/includes/js/inline-wysiwyg.js', array('jquery', 'medium-editor-js'), '1.0.0', true );
}

add_action('admin_enqueue_scripts', 'inline_wysiwyg_enqueue_scripts');
